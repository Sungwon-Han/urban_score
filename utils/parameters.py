...
def siScore_parser():
    ...
    parser.add_argument('--pretrained-path', type=str, default='./checkpoint/resnet18_pretrained.ckpt', help='model path')
    parser.add_argument('--district-path', type=str, default='./data/kr_entire_demographics.csv', help='district information path')
    parser.add_argument('--nightlight-path', type=str, default='./data/kr_nightlight_proxy.csv', help='nightlight information path')
    ...
    parser.add_argument('--mode', type=str, help='graph inference mode ("district" or "nightlight")')
    parser.add_argument('--histogram-path', type=str, default='./data/cluster_kr/histogram_kr.csv', help='histogram information path')
    parser.add_argument('--grid-path', type=str, default='./data/cluster_kr/grid_kr.csv', help='grid cluster information path')
...
def extract_cluster_parser():
    ...
    parser.add_argument('--city_model', type=str, help='cluster model name')
    parser.add_argument('--rural_model', type=str, help='Eval model name')
